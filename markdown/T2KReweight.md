<https://www.t2k.org/asg/oagroup/tool/t2kreweight/installing/installt2krewt>
...
export CVS_RSH=ssh
unset CVS_SERVER
cvs co -d cvs NIWG/neut/tags/neut_5.4.1

sed -i -e '{s/\$(ROOTLIBS) \${MCLIB}/\${MCLIB} \${ROOTLIBS}/g}' \
  ${NEUT_ROOT}/src/neututils/calc_dis_crs/GNUmakefile.calcpicrs \
  ${NEUT_ROOT}/src/neututils/calc_nuc_dens/GNUmakefile \
  ${NEUT_ROOT}/src/neututils/calc_res_crs/GNUmakefile \
  ${NEUT_ROOT}/src/pionsmpl/GNUmakefile \
  ${NEUT_ROOT}/src/reweight/GNUmakefile \
  ${NEUT_ROOT}/src/reweight/old/GNUmakefile
